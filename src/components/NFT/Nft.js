import image1 from "./Hero-nft.webp";
import "./NftStyle.scss";
  ...
  return (
    <div className="container-fluid overflow-hidden p-0 m-0 g-0">
      <div className="row hero-section g-0 m-0 p-sm-5">
        ...
        <div className="col-12 col-sm-6 px-sm-5 my-sm-auto">
          <h1>NFT Development</h1>
          <p>Ensuring Irrefutable Ownership of Digital Assets With NFT</p>
        </div>
      ...
      <div className="row g-0 m-0">
        <div className="col-12 my-5 section-title">
          <h3>Our Services</h3>
          <p>
            We help NFT artists, creators, and SMEs develop robust NFT
            marketplace
            <br />
            platforms in a safe and secure manner.
          </p>
        </div>
      </div>
      ...
      <div className="row  my-5 px-sm-5 py-sm-5 bg-snow">
        ...
        <div style={{ width: "25%" }} className="col-sm-4">
          <div className="row g-0 p-0 m-0">
            <div className="col-sm-6 g-0">
              <span>96%</span>
            </div>
      ...
      <div className="row mx-sm-5 px-sm-5">
        ...
        <div style={{ width: "28%" }} className="col-sm-4 px-sm-4 content-part">
          <div className="icon-benefit mb-sm-4">
            <SelectOutlined />
          </div>
          <div className="text-benefit">
      ...
      <div className="row bg-04 p-sm-5">
        <div className="col-sm-5 g-0 p-sm-5 cta-11-txt">
