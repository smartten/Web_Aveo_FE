      ...
      <div className="retail-section g-0 m-0">
        <div className="container d-flex">
          ...
          >
            ...
            >
              <h1>Retail</h1>
              <p>We transform the retail customer experience with personalized, enterprise omnichannel platforms for your business demands</p>
      ...
      <div className="container">
        <div className="row g-0 m-0">
          <div className="col-12 my-5 section-title">
            ...
            <p>{content && <div dangerouslySetInnerHTML={{ __html: content[2].content }}></div>}</p>
          </div>
        </div>
        ...
        <div className="mobility">
          <div className="row g-0 m-0  mb-sm-3 content-mob">
            <div style={{ marginRight: 'auto' }} className="col-12 col-sm-6 ">
              <div className="row m-0 p-0 g-0">
                <div className="col-12 col-lg-2">
                  <img src={content && content[2]?.list[0]?.link} alt="" />
                </div>
                <div className="col-12 col-lg-10 fbox-txt">
                  <h5>{content && content[2]?.list[0]?.title}</h5>
                  <p>{content && <div dangerouslySetInnerHTML={{ __html: content[2]?.list[0]?.content }}></div>}</p>
                </div>
              </div>
            </div>
            <div className="col-12 col-sm-6">
              <div className="row m-0 p-0 g-0">
                <div className="col-12 col-lg-2">
                  <img src={content && content[2]?.list[1]?.link} alt="" />
                </div>
                <div className="col-12 col-lg-10 fbox-txt">
                  <h5>{content && content[2]?.list[1]?.title}</h5>
                  <p>{content && <div dangerouslySetInnerHTML={{ __html: content[2]?.list[1]?.content }}></div>}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mobility-2">
          <div className="row g-0 m-0 mb-sm-3 content-mob">
            <div style={{ marginRight: 'auto' }} className="col-12 col-sm-6 ">
              <div className="row m-0 p-0 g-0">
                <div className="col-12 col-lg-2">
                  <img src={content && content[2]?.list[2]?.link} alt="" />
                </div>
                <div className="col-12 col-lg-10 fbox-txt">
                  <h5>{content && content[2]?.list[2]?.title}</h5>
                  <p>{content && <div dangerouslySetInnerHTML={{ __html: content[2]?.list[2]?.content }}></div>}</p>
                </div>
              </div>
            </div>
            <div className="col-12 col-sm-6">
              <div className="row m-0 p-0 g-0">
                <div className="col-12 col-lg-2">
                  <img src={content && content[2]?.list[3]?.link} alt="" />
                </div>
                <div className="col-12 col-lg-10 fbox-txt">
                  <h5>{content && content[2]?.list[3]?.title}</h5>
                  <p>{content && <div dangerouslySetInnerHTML={{ __html: content[2]?.list[3]?.content }}></div>}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mobility-3">
          <div className="row g-0 m-0 mb-sm-3 content-mob">
            <div style={{ marginRight: 'auto' }} className="col-12 col-sm-6 ">
              <div className="row m-0 p-0 g-0">
                <div className="col-12 col-lg-2">
                  <img src={content && content[2]?.list[4]?.link} alt="" />
                </div>
                <div className="col-12 col-lg-10 fbox-txt">
                  <h5>{content && content[2]?.list[4]?.title}</h5>
                  <p>{content && <div dangerouslySetInnerHTML={{ __html: content[2]?.list[4]?.content }}></div>}</p>
                </div>
              </div>
            </div>
            <div className="col-12 col-sm-6">
              <div className="row m-0 p-0 g-0">
                <div className="col-12 col-lg-2">
                  <img src={content && content[2]?.list[5]?.link} alt="" />
                </div>
                <div className="col-12 col-lg-10 fbox-txt">
                  <h5>{content && content[2]?.list[5]?.title}</h5>
                  <p>{content && <div dangerouslySetInnerHTML={{ __html: content[2]?.list[5]?.content }}></div>}</p>
                </div>
              </div>
            </div>
          </div>
