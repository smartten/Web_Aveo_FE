            ...
            <div className="container">
              <div className="slide-content">
                <div className="text">
                  ...
                  <p className="sub-text">We'll help you build a scalable, secure platform that will guide your buyer through a seamless purchasing process</p>
            ...
            <div class="row justify-content-center">
              <div class="col-lg-10 col-xl-8">
                <div class="section-title title-01 mb-70">
                  ...
                  <p class="sub-title">{content && <div dangerouslySetInnerHTML={{ __html: content[3]?.content }} />}</p>
                </div>
              </div>
            </div>
          </div>
